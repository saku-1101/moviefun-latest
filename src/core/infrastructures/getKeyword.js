...
var mecab_client_1 = require("mecab-client");
var axios_1 = require("axios");
// TMDB APIキーとベースURL
var API_KEY = 'YOUR_API_KEY';
var BASE_URL = 'https://api.themoviedb.org/3';
// MeCabのインスタンスを生成
var mecab = new mecab_client_1.MeCab();
// テキストからキーワードを抽出する関数
function extractKeywords(text) {
    return __awaiter(this, void 0, void 0, function () {
        var nodes, keywords, _i, nodes_1, node, lexical, surface;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, mecab.parse(text)];
                case 1:
                    nodes = _a.sent();
                    keywords = [];
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, axios_1["default"].get("".concat(BASE_URL, "/search/keyword"), {
                            params: {
                                api_key: API_KEY,
                                query: keyword
                            }
...
function extractKeywordsAndIds(text) {
    return __awaiter(this, void 0, void 0, function () {
        var keywords, keywordIds;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, extractKeywords(text)];
                case 1:
                    keywords = _a.sent();
                    return [4 /*yield*/, getKeywordIds(keywords)];
                case 2:
                    keywordIds = _a.sent();
                    console.log(keywordIds);
                    return [2 /*return*/, keywordIds];
            }
        });
    });
}
